...
function SettingsScreen({data,setData,showToast}:{data:AppData;setData:(d:AppData)=>void;showToast:(s:string)=>void}){
  ...
  const fields:Array<[keyof AlgorithmSettings,string]>=[['luckWeight','Luck weight'],['arrowWeight','Arrow weight'],['arrowSweetSpot','Arrow sweet spot'],['arrowDiminishingMultiplier','Arrow 75–90 multiplier'],['arrowCeiling','Arrow flat region starts'],['arrowPenaltyThreshold','Arrow penalty starts'],['arrowOvercapPenaltyMultiplier','Arrow > penalty threshold multiplier'],['npcWeight','NPC Offers weight'],['energyWeight','Energy weight'],['energyTarget','Energy target'],['energySecondStageMultiplier','Energy 50–100 multiplier'],['energyCeiling','Energy ceiling'],['zoneWeight','Zone weight'],['zoneBreakpoint1','Zone breakpoint 1'],['zoneBreakpoint2','Zone breakpoint 2'],['zoneMultiplier2','Zone middle multiplier'],['zoneMultiplier3','Zone upper multiplier'],['tipWeight','Tip weight'],['recoveryWeight','Recovery weight'],['vehicleWeight','Vehicle weight'],['walkWeight','Walk weight'],['sunnyUptime','Sunny uptime'],['nocturnalUptime','Nocturnal uptime'],['raindropUptime','Raindrop uptime'],['overchargedMultiplier','Overcharged general-use multiplier'],['timeKeeperWeight','Time Keeper weight (PROVISIONAL)']];
